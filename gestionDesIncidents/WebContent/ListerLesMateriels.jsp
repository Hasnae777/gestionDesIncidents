...
<%@page import="gestionDesIncidents.Materiel"%><%@page import="gestionDesIncidents.MaterielImpl"%><%@page import="java.util.ArrayList"%><%@page import="java.util.Iterator"%>
...
<tr class="sign-up">
	...
	<th style="background-color:#EFEFEF;">Numero de serie</th>
	<th style="background-color:#EFEFEF;">Type</th><th style="background-color:#EFEFEF;">Modele</th>
	<th style="background-color:#EFEFEF;">Nom</th><th style="background-color:#EFEFEF;">User</th>
	<th style="background-color:#EFEFEF;">Etat</th><th style="background-color:#EFEFEF;">Ip</th>
	<th style="background-color:#EFEFEF;">MAC</th><th style="background-color:#EFEFEF;">Systeme d'exploitation</th>
	<th style="background-color:#EFEFEF;">Processeur</th><th style="background-color:#EFEFEF;">RAM</th>
	<th style="background-color:#EFEFEF;">Lieu</th><th style="background-color:#EFEFEF;">Date d'achat</th>
	<th style="background-color:#EFEFEF;">Date d'affectation</th><th style="background-color:#EFEFEF;">Duree de garantie</th>
	<th style="background-color:#EFEFEF;">Date de derniere modification</th><th style="background-color:#EFEFEF;">Fabricant</th>
	<th style="background-color:#EFEFEF;">Description</th></p>
	
</tr>
	
	<%
	MaterielImpl materiel= new MaterielImpl();
	List<Materiel> mat= materiel.getMateriel(); %>
	<%for(Materiel r :mat){ %>
...
<a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'" ><img src="delete.png" ></a>     <div id="light" class="white_content">
			...
			<a href="http://localhost:8080/gestionDesIncidents/SupprimerMateriel.jsp?login=<%= login %>&idMateriel=<%= r.getIdMateriel() %>" class="myButton">oui</a>
		...
		<td><a href="http://localhost:8080/gestionDesIncidents/ModifMateriel.jsp?idMateriel=<%= r.getIdMateriel() %>"><img src="modifier.png"></a>
</td>
			...
			<td><%= r.getNumSerie() %></td>
			<td><%= r.getType() %></td>
			<td width="90px"><%= r.getModele() %></td>
			<td width="90px"><%= r.getNom() %></td>
			<td width="90px"><%= r.getUser() %></td>
			<td><%= r.getEtat() %></td>
			<td><%= r.getIP() %></td>
			<td><%= r.getMac() %></td>
			<td><%= r.getOs() %></td>
			<td width="100px" ><%= r.getProcesseur() %></td>
			<td width="90px"><%= r.getRam() %></td>
			<td><%= r.getLieu() %></td>
			<td><%= r.getDateAchat() %></td>
			<td width="110px"><%= r.getDateAffectation() %></td>
			<td><%= r.getDureeGarantie() %></td>
			<td><%= r.getDateDerniereMod() %></td>
			<td width="100px"><%= r.getFabricant() %></td>
			<td width="100px"><%= r.getDescription() %></td>
			</tr>
		<% }} %>
