	...
	<body class="page">
		...
		<main role="main">
			...
			<div id="main">
				...
				int total=ticket.nouveauT()+ticket.enattenteT()+ticket.resoluT()+ticket.closT();
				float pNouveau =(ticket.nouveauT()*100)/total;
				float pAttente=(ticket.enattenteT()*100)/total;
				float pResolu=(ticket.resoluT()*100)/total;
				float pClos=(ticket.closT()*100)/total;
	
	
				%>
				<section class="row section">
					<div class="row-content buffer even clear-after">
						<div class="section-title"><h3>Les tickets</h3></div>
						<p class="centertxt">Voici le pourcentage des tickets qui existent dans l'agance</p>
						<div class="chart" data-percent="<%= pNouveau %> data-bar-color="#fd685b" data-animate="2000">
							<div class="chart-content">
								<div class="percent"></div>
								<div class="chart-title">Nouveaux</div>
							</div><!-- chart-content -->
						</div><!-- chart -->
						<div class="chart" data-percent="<%= pAttente %>" data-bar-color="#ffce54" data-animate="2500">
							<div class="chart-content">
								<div class="percent"></div>
								<div class="chart-title">En attente</div>
							</div><!-- chart-content -->
						</div><!-- chart -->
						<div class="chart" data-percent="<%= pResolu %>" data-bar-color="#a0d468" data-animate="3000">
							<div class="chart-content">
								<div class="percent"></div>
								<div class="chart-title">Resolus</div>
							</div><!-- chart-content -->
						</div><!-- chart -->
						<div class="chart" data-percent="<%= pClos %>" data-bar-color="#ac92ec" data-animate="3500">
							<div class="chart-content">
								<div class="percent"></div>
								<div class="chart-title">Clos</div>
							</div><!-- chart-content -->
						</div><!-- chart -->
					</div>	
				</section>
