...
String priorite=request.getParameter("priorite");
	...
	<body class="page">
		...
		<main role="main">
         ...
         action="http://localhost:8080/gestionDesIncidents/PrendreEnCharge.jsp?idTicket=<%= idTicket%>&nomTech=<%=login%>&dateDebut=<%=dateDebut%>&priorite=<%=priorite%>" method="post">
    <div id="light" class="white_content">
 <label for="nomTech"> <b>login du techncien: </b>  </label>
    <input type="text" name="nomTech" style="width: 17%;" />
