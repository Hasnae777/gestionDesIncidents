...
<main role="main">
		...
		<form class="sign-up" action="http://localhost:8080/gestionDesIncidents/ModifierLogiciel.jsp?idLogiciel=<%= idLogiciel%>" method="post">
	
    
<h1 class="sign-up-title">Modifier l'equipement reseau</h1>
    
<label for="etat">        Etat :</label>  <select name="etat" class="sign-up-input" >
