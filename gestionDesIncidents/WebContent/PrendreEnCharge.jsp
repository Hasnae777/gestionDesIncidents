...
PreparedStatement ps=conn.prepareStatement("insert into priseencharge(dateDebut,dateDerniereMod,statutP,note,idTicket,nomTech,dureeTache,statut,priorite) values(?,NOW(),?,?,?,?,TIMEDIFF(NOW(),dateDebut),?,?)");
...
String redirectURL = "http://localhost:8080/gestionDesIncidents/consulterTicketTech.jsp?login="+nomTech;
