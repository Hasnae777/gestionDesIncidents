<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%><%@page import="gestionDesIncidents.Logiciel"%><%@page import="gestionDesIncidents.LogicielImpl"%><%@page import="java.util.List"%>
...
<th style="background-color:#EFEFEF;" ></th><th style="background-color:#EFEFEF;" ></th>
	...
	<th style="background-color:#EFEFEF;">Nom</th><th style="background-color:#EFEFEF;">Version</th>
	<th style="background-color:#EFEFEF;">Numero de serie</th><th style="background-color:#EFEFEF;">Licence</th>
	<th style="background-color:#EFEFEF;">Date d'achat</th><th style="background-color:#EFEFEF;">Date d'Expiration</th>
	<th style="background-color:#EFEFEF;">Etat</th></p>
</tr>
	<%
	LogicielImpl reseau= new LogicielImpl();
	List<Logiciel> log= reseau.getLogiciel(); 
...
<a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'" ><img src="delete.png" ></a>     <div id="light" class="white_content">
			...
			<a href="http://localhost:8080/gestionDesIncidents/SupprimerLogiciel.jsp?login=<%= login %>&idLogiciel=<%= r.getIdLogiciel() %>" class="myButton">oui</a>
			   <a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'">non</a></div>
			    <div id="fade" class="black_overlay"></div>		
					...
					<td><a href="http://localhost:8080/gestionDesIncidents/ModifLogiciel.jsp?idLogiciel=<%= r.getIdLogiciel() %>"><img src="modifier.png"></a>
			
			<td><%= r.getIdLogiciel() %></td>
			<td><%= r.getType() %></td>
			<td><%= r.getNom() %></td>
			<td><%= r.getVersion() %></td>
			<td><%= r.getNumSerie() %></td>
