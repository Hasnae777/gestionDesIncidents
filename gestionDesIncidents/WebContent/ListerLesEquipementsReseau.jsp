<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%><%@page import="gestionDesIncidents.EquipementReseau"%><%@page import="gestionDesIncidents.ReseauImpl"%><%@page import="java.util.List"%>
...
<table border="1" id="marilyn">


<tr class="sign-up">
	<th style="background-color:#EFEFEF;"></th><th style="background-color:#EFEFEF;"></th><th style="background-color:#EFEFEF;">Type</th>
	<th style="background-color:#EFEFEF;">Nom</th><th style="background-color:#EFEFEF;">IP</th>
	<th style="background-color:#EFEFEF;">Network</th><th style="background-color:#EFEFEF;">MAC</th>
	<th style="background-color:#EFEFEF;">Port</th><th style="background-color:#EFEFEF;">Date d'ajout</th>
	<th style="background-color:#EFEFEF;">Etat</th>
</tr>
	<%
	ReseauImpl reseau= new ReseauImpl();
	List<EquipementReseau> res= reseau.getReseau(); %>
	<tr>
	<%for(EquipementReseau r :res){ %>
	...
	<a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'" ><img src="delete.png" ></a>     <div id="light" class="white_content">
			...
			<a href="http://localhost:8080/gestionDesIncidents/SupprimerReseau.jsp?login=<%= login %>&idReseau=<%= r.getIdReseau() %>" class="myButton">oui</a>
			   <a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'">non</a></div>
			    <div id="fade" class="black_overlay"></div>		
					...
					<td><a href="http://localhost:8080/gestionDesIncidents/modifReseau.jsp?idReseau=<%= r.getIdReseau() %>&login=<%= login %>"><img src="modifier.png"></a>
