...
session.putValue("idTechnicien", idTechnicien);
...
PreparedStatement ps=conn.prepareStatement("UPDATE technicien SET nom=?, prenom=?, email=?, numTel=?, login=?, groupeName=? WHERE idTechnicien="+idTechnicien);
ps.setString(1, nom);
ps.setString(2, prenom);
ps.setString(3, email);
ps.setString(4, numTel);
ps.setString(5, loginT);
ps.setString(6, groupeName);
