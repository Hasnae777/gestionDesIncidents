...
<br><br>
<div class="box">
      <input type="search" name="titre" placeholder="Search..." />
      <a href="http://localhost:8080/gestionDesIncidents/searchTitre.jsp"><span class="icon"><i class="fa fa-search"></i></span></a>
</div>
        <%
...
<% if(e.getPriorite().equals("Critique")){
				%><td width="90px" style="background-color:#A80000  ;"><%= e.getPriorite() %></td>			<td><%= e.getTitre() %></td>
			<td><%= e.getLieu() %></td>
			...
			<%}
				...
				%><td width="90px" style="background-color:red ;"><%= e.getPriorite() %></td>
				<td><%= e.getTitre() %></td>
			<td><%= e.getLieu() %></td>
			<td><%= e.getDescription() %></td>
			<td width="100px"><%= e.getStatut() %></td>
			...
			<%	}
				...
				%><td width="90px" style="background-color:orange ;"><%= e.getPriorite() %></td>
			<td><%= e.getTitre() %></td>
			<td><%= e.getLieu() %></td>
			<td><%= e.getDescription() %></td>
			<td width="100px"><%= e.getStatut() %></td>
		...
		%><td width="90px" style="background-color:#00FF00 ;"><%= e.getPriorite() %></td>
		<td><%= e.getTitre() %></td>
<td><%= e.getLieu() %></td>
			<td><%= e.getDescription() %></td>
			<td width="100px"><%= e.getStatut() %></td>
		...
		%><td width="90px" style="background-color:#CCFF99 ;"><%= e.getPriorite() %></td>
		<td><%= e.getTitre() %></td>
		<td><%= e.getLieu() %></td>
			<td><%= e.getDescription() %></td>
			<td width="100px"><%= e.getStatut() %></td>
