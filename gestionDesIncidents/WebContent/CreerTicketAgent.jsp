...
<%String login= request.getParameter("employeId");%>
<head>
		<meta charset="utf-8">
	...
	<body class="page">
		...
		<br>			
<div>
<form class="sign-up" action="http://localhost:8080/gestionDesIncidents/creerUnTicket.jsp?login=<%= login %>" method="post">
